(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \***************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _story_story_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./story/story.component */ './src/app/story/story.component.ts'
        );
        /* harmony import */ var _poll_poll_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./poll/poll.component */ './src/app/poll/poll.component.ts'
        );
        /* harmony import */ var _role_guard_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./role-guard.service */ './src/app/role-guard.service.ts'
        );
        /* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ./login/login.component */ './src/app/login/login.component.ts'
        );
        /* harmony import */ var _login_guard_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./login-guard.service */ './src/app/login-guard.service.ts'
        );
        ...
        var routes = [
          {
            path: 'story',
            component:
              _story_story_component__WEBPACK_IMPORTED_MODULE_3__[
                'StoryComponent'
              ]
          },
          {
            path: 'poll',
            component:
              _poll_poll_component__WEBPACK_IMPORTED_MODULE_4__['PollComponent']
          },
          {
            path: 'login',
            component:
            ...
            canActivate: [
              _login_guard_service__WEBPACK_IMPORTED_MODULE_7__[
                'LoginGuardService'
              ]
            ]
          },
          {
            ...
            canActivate: [
              _role_guard_service__WEBPACK_IMPORTED_MODULE_5__[
                'RoleGuardService'
              ]
            ],
  ...
  \*******************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _story_story_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ./story/story.component */ './src/app/story/story.component.ts'
        );
        /* harmony import */ var _poll_poll_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./poll/poll.component */ './src/app/poll/poll.component.ts'
        );
        /* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ./login/login.component */ './src/app/login/login.component.ts'
        );
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__['NgModule'])({
                declarations: [
                  ...
                  _story_story_component__WEBPACK_IMPORTED_MODULE_9__[
                    'StoryComponent'
                  ],
                  _poll_poll_component__WEBPACK_IMPORTED_MODULE_10__[
                    'PollComponent'
                  ],
  ...
  \*********************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! @auth0/angular-jwt */ './node_modules/@auth0/angular-jwt/index.js'
        );
        /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! @angular/common/http */ './node_modules/@angular/common/fesm5/http.js'
        );
        /* harmony import */ var _key__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../key */ './key.ts'
        );
        ...
        var helper = new _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_2__[
          'JwtHelperService'
        ]();
        var AuthService = /** @class */ (function() {
          ...
          AuthService.prototype.doLogin = function(loginInfo) {
            return this.http
              .post(
                _key__WEBPACK_IMPORTED_MODULE_4__['environment'].API +
                  '/login/',
                loginInfo
              )
              .pipe(
  ...
  \****************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! @auth0/angular-jwt */ './node_modules/@auth0/angular-jwt/index.js'
        );
        ...
        var helper = new _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_3__[
          'JwtHelperService'
        ]();
  ...
  \******************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _signup_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../signup.service */ './src/app/signup.service.ts'
        );

        var LoginComponent = /** @class */ (function() {
          function LoginComponent(toastr, auth, router, fb, signup) {
            this.toastr = toastr;
            this.auth = auth;
            this.router = router;
            this.fb = fb;
            ...
            this.formGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
              ...
              phoneNumber: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__[
                'FormControl'
              ]('', [
          ...
          LoginComponent.prototype.onPressSignUp = function() {
            this.signup.signUp(this.signUpForm.value).subscribe(function() {
              return console.log('signup done');
            });
          };
  ...
  \****************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _writer_poll_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../writer/poll.service */ './src/app/writer/poll.service.ts'
        );
          ...
          PollComponent = tslib__WEBPACK_IMPORTED_MODULE_0__['__decorate'](
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__['Component'])({
                selector: 'app-poll',
                template: __webpack_require__(
                  /*! ./poll.component.html */ './src/app/poll/poll.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./poll.component.css */ './src/app/poll/poll.component.css'
                  )
                ]
              }),
              tslib__WEBPACK_IMPORTED_MODULE_0__['__metadata'](
                'design:paramtypes',
                [
                  _writer_poll_service__WEBPACK_IMPORTED_MODULE_2__[
                    'PollService'
                  ]
                ]
              )
  ...
  \***********************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var key__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! key */ './key.ts'
        );
  ...
  \******************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _story_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        var StoryComponent = /** @class */ (function() {
          ...
          StoryComponent.prototype.getFileUrl = function(filename) {
            return (
              key__WEBPACK_IMPORTED_MODULE_3__['environment'].API +
              '/story/storyImage/' +
              filename
            );
          };
          ...
          StoryComponent.prototype.ngOnInit = function() {
            ...
            this.story.getActiveStories().subscribe(function(data) {
          ...
          StoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__['__decorate'](
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__['Component'])({
                selector: 'app-story',
                template: __webpack_require__(
                  /*! ./story.component.html */ './src/app/story/story.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./story.component.css */ './src/app/story/story.component.css'
                  )
                ]
              }),
              tslib__WEBPACK_IMPORTED_MODULE_0__['__metadata'](
  ...
  \***************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! /home/ri.virmani/newspaper/src/main.ts */ './src/main.ts'
        );
